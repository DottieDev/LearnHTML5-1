...
function saveNewChampion(event) {
  ...
  var scheduleDate = this.elements.namedItem("scheduleDate").value;
  var faveColor = this.elements.namedItem("faveColor").value;
  ...
  newChampion.innerHTML = "<p>#" + rank + "</p>" +
    "<p>" + name + " " + stars + "</p>" +
    "<p>Next game: " + scheduleDate + "</p>" +
    "<p><a href='mailto:" + email + "'>" + email + "</a></p>";

  champions.appendChild(newChampion);
  this.style.backgroundColor = faveColor;
  
}

function setEnemySpeed(speed) {
  enemy.setSpeed(speed * 10);
}
...
function getWords() {
  var phrases = [
    ...
    "I must win my dream boat before the bad guy takes it from me.",
